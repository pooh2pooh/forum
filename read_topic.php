		...
		<div class="container">
			<div class="d-flex flex-wrap align-items-center justify-content-center">
				<ul class="nav col-12 my-1 justify-content-around my-md-0 text-small">
					...
					<li class="text-center"><a class="nav-link" data-bs-toggle="modal" href="#modalEditor" role="button"><i class="bi bi-send-plus-fill mx-auto mb-1" style="font-size: 1.3rem;"></i><br>ЗАПОСТИТЬ</a></li>
